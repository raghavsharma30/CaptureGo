...
private:
    ...
    Piece piece;
public:
    ChainAndLiberties(const vector<Point>& chain, const unordered_set<Point>& liberties, Piece piece) 
        : chain(chain), liberties(liberties), piece(piece) {}
...
private:
    ...
    void findChainAndLiberties(int x, int y, Piece piece, vector<vector<bool>>& visited, 
